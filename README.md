...
Initially the user will need to register with the XQ Framework. To do so, they click the **Register** button which promts them for their email. A PIN code will be sent to that email.
